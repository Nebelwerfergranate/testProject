				...
				$.each($t.p.colModel,function(){
					...
					switch (this.stype) {
						...
						case 'text':
							...
							break;
					    case 'datetimerange':
					        var $fromElem = $($elem.selector + 'From', $elem.context);
					        var $toElem = $($elem.selector + 'To', $elem.context);

					        var proceed = function ($elem, nm) {
					            $elem.val(v || "");
					            if (v !== undefined) {
					                sdata[nm] = v;
					                j++;
					        ...
					        proceed($fromElem, nm + 'From');
					        proceed($toElem, nm + 'To');            				        
				...
				if(this.search){
					...
					case "text":
					    ...
					    case "datetimerange":
					        ...
					        $("td:eq(1)", stbl).append("<input type='text' style='width:100%;padding:0px;' name='" + (cm.index + "From" || cm.name + "From") + "' id='gs_" + cm.name + "From" + "' value='" + df + "'/>"
                                + "<input type='text' style='width:100%;padding:0px;' name='" + (cm.index + "To" || cm.name + "To") + "' id='gs_" + cm.name + "To" + "' value='" + df + "'/>");
					        $(thd).append(stbl);
